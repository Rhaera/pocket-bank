...
public class ContaPoupanca extends ContaBancaria {
    ...
    public ContaPoupanca(@NonNull String agencia, @NonNull String numeroConta, @NonNull Client client, @NonNull LocalDate criacaoDaConta, List<MovimentacaoFinanceira> extrato) {
